...
library(dfadjust)
```
The implementation, described below, allows for fixed effects and for large clusters. Examples: TODO
<!-- TODO: example with few treated, with few treated clusters, and with fixed effects, and with large clusters -->
